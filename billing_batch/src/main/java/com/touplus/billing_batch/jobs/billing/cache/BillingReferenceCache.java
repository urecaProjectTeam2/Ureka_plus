...
public class BillingReferenceCache {
    ...
    private volatile Map<Long, ProductBaseUsageDto> productBaseUsageMap = new HashMap<>();
    ...
    public void updateProductBaseUsageMaps(Map<Long, ProductBaseUsageDto> newMap) {
    ...
    public Map<Long, ProductBaseUsageDto> getProductBaseUsageMap() {
